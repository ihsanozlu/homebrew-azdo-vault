class AzdoVault < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      def install
        bin.install "azdo-vault-darwin-arm64" => "azdo-vault"
      ...
      def install
        bin.install "azdo-vault-darwin-amd64" => "azdo-vault"
        generate_completions_from_executable(bin/"azdo-vault", "completion")
      end
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      def install
        bin.install "azdo-vault-linux-arm64" => "azdo-vault"
        generate_completions_from_executable(bin/"azdo-vault", "completion")
      end
    else
      ...
      def install
        bin.install "azdo-vault-linux-amd64" => "azdo-vault"
        generate_completions_from_executable(bin/"azdo-vault", "completion")
      end
    end
  end
  ...
  test do
    assert_match "Version", shell_output("#{bin}/azdo-vault version")
  end
end
